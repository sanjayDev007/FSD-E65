...
function WeatherCard({data}) {
    let location = `${data?.location?.name}, ${data?.location?.region}, ${data?.location?.country} ` || "Not Found";
  return (
    <>
      <div className="cardm">
        <div className="card">
          ...
          >
            ...
            <image
              ...
              x={0}
              y={0}
              href={data?.current?.condition?.icon || "Not Found"}
            />
          </svg>
          <div className="main">{data?.current?.temp_c || "Not Found"} °C</div>
          ...
          <div className="upper">
            <div className="humidity">
              <div className="humiditytext">
                Humidity
                <br />
                {data?.current?.humidity || "Not Found"}%
              </div>
              <svg
                xmlSpace="preserve"
                viewBox="0 0 30 30"
    ...
    KHRFWHRkYXRlOnRpbWVzdGFtcAAyMDIzLTAyLTE2VDE4OjE5OjAwKzAwOjAwSbgwlgAAAABJRU5ErkJggg=="
            ...
            <div className="air">
              <div className="airtext">
                Wind
                <br />{data?.current?.wind_kph || "Not Found"} Km/h
              </div>
              <svg
                className="airsvg"
                version="1.1"
    ...
    MjUrMDA6MDBiirAvAAAAAElFTkSuQmCC"
              ...
              <span className="text-nowrap">Heat Index</span>
                <br />
                {data?.current?.heatindex_c || "Not Found"} °C
              </div>
            </div>
    ...
    OFQwNToxNToyNiswMDowMIjQlfwAAAAASUVORK5CYII="
              ...
              <div className="realfeeltext">
                <span className="text-nowrap">Real Feel</span>
                <br />
                {data?.current?.feelslike_c || "Not Found"} °C
              </div>
            </div>
    ...
    Ut8AAAAASUVORK5CYII="
              ...
              <div className="pressuretext">
                Pressure
                <br />
                <span className="text-nowrap pr-1">{data?.current?.pressure_mb || "Not Found"} mbar</span>
              </div>
            </div>
            <div className="card3">{data?.current?.condition?.text || "Not Found"}</div>
          </div>
        </div>
      </div>
    </>
